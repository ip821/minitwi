...
MIDL_DEFINE_GUID(IID, IID_IImageManagerService,0x828C2337,0x535F,0x491B,0x94,0x3D,0xED,0xF9,0x3F,0x76,0x0C,0xB7);
...
MIDL_DEFINE_GUID(IID, IID_ITimelineControlEventSink,0x53ADEAC2,0x0827,0x4AAF,0x9B,0x82,0xE6,0x95,0xAC,0xC1,0x49,0x18);
...
MIDL_DEFINE_GUID(IID, IID_IDownloadServiceEventSink,0x5304DEAC,0x784A,0x457C,0x90,0x37,0x1E,0x87,0x8B,0x9D,0x2E,0xAA);


MIDL_DEFINE_GUID(IID, IID_IDownloadService,0x18A1A514,0x1F78,0x4811,0xB4,0x69,0x50,0x9C,0xFE,0x4A,0xAF,0x94);


MIDL_DEFINE_GUID(IID, IID_IUpdateService,0xB9A65F18,0x0B3C,0x4612,0xB0,0xA6,0xB1,0x01,0x07,0xF3,0x99,0x09);


MIDL_DEFINE_GUID(IID, IID_IWindowEventSink,0xEF814E3D,0xBAFD,0x48BF,0x8D,0xAC,0x29,0xCD,0x2F,0x23,0x8F,0x64);


MIDL_DEFINE_GUID(IID, IID_IWindow,0x2620EF14,0x88EB,0x44D8,0x9A,0xCA,0x56,0xE0,0x86,0x6E,0x3A,0x09);


MIDL_DEFINE_GUID(IID, IID_IPictureWindow,0x6687C546,0x6AB5,0x4D4F,0x90,0x54,0x9A,0xE4,0x5E,0x55,0xAA,0xEB);


MIDL_DEFINE_GUID(IID, IID_IWindowService,0xB3C5E00B,0xC8CF,0x4CF5,0x91,0x47,0xED,0x5E,0x0C,0xF2,0x0F,0x01);
...
MIDL_DEFINE_GUID(CLSID, CLSID_ImageManagerService,0x204D2E4F,0x72BE,0x41EF,0x8B,0x7D,0x99,0x2B,0x89,0xBE,0x36,0xDA);


MIDL_DEFINE_GUID(CLSID, CLSID_DownloadService,0x8A7C5710,0x9FCB,0x4FD9,0x83,0xA2,0x36,0xEE,0x81,0xE1,0x0F,0xB9);


MIDL_DEFINE_GUID(CLSID, CLSID_UpdateService,0x8C2F7C68,0xA0A4,0x4A79,0x99,0x08,0x5F,0xE3,0xD1,0x59,0x6C,0x7A);


MIDL_DEFINE_GUID(CLSID, CLSID_PictureWindow,0x10AEB079,0xCE14,0x4F8F,0x8C,0xEE,0xC4,0xC6,0x42,0x8B,0xD4,0xE8);


MIDL_DEFINE_GUID(CLSID, CLSID_WindowService,0xDD23A3C8,0xD851,0x4F92,0x92,0x01,0x27,0x6E,0xD7,0x0C,0x16,0x2F);
