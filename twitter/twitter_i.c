...
MIDL_DEFINE_GUID(IID, IID_IColumnInfo,0x924BA62A,0x74BF,0x463A,0x80,0x08,0x49,0x7B,0x24,0x1F,0xC4,0x48);
...
MIDL_DEFINE_GUID(CLSID, CLSID_ColumnInfo,0x617A1078,0x6B41,0x4A61,0x88,0xD5,0x38,0xFC,0xF8,0x61,0xCB,0xB2);
