...
MIDL_DEFINE_GUID(IID, IID_ITimelineUpdateImageService,0x22180299,0x0223,0x49F2,0x8E,0x63,0x1D,0x38,0x69,0x16,0x06,0x76);
...
MIDL_DEFINE_GUID(CLSID, CLSID_TimelineUpdateImageService,0x5DD83D05,0xC14B,0x404F,0xA9,0x79,0x4A,0xCA,0xBB,0x55,0x16,0x55);
