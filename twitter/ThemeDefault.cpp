...
HRESULT CThemeDefault::FinalConstruct()
{
	...
	RETURN_IF_FAILED(m_pThemeFontMap->SetFont(VAR_TWITTER_CREATED_AT, FONT_NAME, FONT_SIZE, FALSE, FALSE));
	RETURN_IF_FAILED(m_pThemeFontMap->SetFont(CComBSTR(VAR_TWITTER_CREATED_AT + CString(VAR_SELECTED_POSTFIX)), FONT_NAME, FONT_SIZE, FALSE, TRUE));
