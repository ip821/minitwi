...
HRESULT CThemeDefault::FinalConstruct()
{
	...
	RETURN_IF_FAILED(m_pThemeFontMap->SetFont(CComBSTR(VAR_TWITTER_NORMALIZED_TEXT + CString(VAR_DOUBLE_SIZE_POSTFIX)), FONT_NAME, (DWORD)(FONT_SIZE * 1.4), FALSE, FALSE));
