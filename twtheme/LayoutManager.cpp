...
STDMETHODIMP CLayoutManager::GetElements(IVariantObject* pVariantObject, IObjArray** ppObjArray)
{
...
STDMETHODIMP CLayoutManager::GetElementType(IVariantObject* pVariantObject, ElementType* pElementType)
{
	...
	if (CComBSTR(vLayoutType.bstrVal) == CComBSTR(Twitter::Themes::Metadata::LayoutTypes::HorizontalContainer))
		...
		*pElementType = ElementType::Unknown;
	return S_OK;
}

STDMETHODIMP CLayoutManager::BuildHorizontalContainer(HDC hdc, RECT* pRect, IVariantObject* pLayoutObject, IVariantObject* pValueObject, IColumnsInfo* pColumnInfo)
{
	return S_OK;
}
